 ...
 */
public class NVMFsCheckpointStreamFactory implements CheckpointStreamFactory {

    private static final Logger LOG = LoggerFactory.getLogger(NVMFsCheckpointStreamFactory.class);
     ...
     */
    public NVMFsCheckpointStreamFactory(
